...
public class SharedPref {
    ...
    final public String user_type = "user_type";
    ...
    // final public String user_image = "user_image";
    // Room Search Filter Keys
    final public String search_property_type = "search_property_type";
    final public String search_room_type = "search_room_type";
    final public String search_gender_type = "search_gender_type";
    final public String search_min_budget = "search_min_budget";
    final public String search_max_budget = "search_max_budget";
    final public String search_pincode = "search_pincode";
    final public String search_housing_name = "search_housing_name";
    final public String search_housing_id = "search_housing_id";
    ...
    public float getPrefFloat(Context context, String key) {
        SharedPreferences settings = context.getSharedPreferences(
                LOGIN_SHARED_FILE, Context.MODE_PRIVATE);
